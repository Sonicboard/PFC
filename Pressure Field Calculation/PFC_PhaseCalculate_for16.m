function phase = PFC_PhaseCalculate_for16(target, array, Lf)
%%
    ...
    % Normalize phase to multiples of pi/4
    phase = round(phase / (pi / 32)) * (pi / 32);

    % Ensure phase is within 0 to 2*pi
